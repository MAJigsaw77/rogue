...
typedef GLVULKANPROCNV = Callable<()->Void>;
...
extern class GL
{
	...
	@:native('glTexImage1D')
	static function texImage1D(target:GLenum, level:GLint, internalformat:GLint, width:GLsizei, border:GLint, format:GLenum, type:GLenum, pixels:VoidPointer):Void;

	@:native('glTexImage2D')
	static function texImage2D(target:GLenum, level:GLint, internalformat:GLint, width:GLsizei, height:GLsizei, border:GLint, format:GLenum, type:GLenum, pixels:VoidPointer):Void;
	...
	@:native('glReadPixels')
	static function readPixels(x:GLint, y:GLint, width:GLsizei, height:GLsizei, format:GLenum, type:GLenum, pixels:VoidPointer):Void;
	...
	static function getTexImage(target:GLenum, level:GLint, format:GLenum, type:GLenum, pixels:VoidPointer):Void;
	...
	@:native('glCallLists')
	static function callLists(n:GLsizei, type:GLenum, lists:VoidPointer):Void;
	...
	@:native('glDrawPixels')
	static function drawPixels(width:GLsizei, height:GLsizei, format:GLenum, type:GLenum, pixels:VoidPointer):Void;
	...
	static function drawElements(mode:GLenum, count:GLsizei, type:GLenum, indices:VoidPointer):Void;

	@:native('glGetPointerv')
	static function getPointerv(pname:GLenum, params:RawPointer<VoidPointer>):Void;
	...
	static function texSubImage1D(target:GLenum, level:GLint, xoffset:GLint, width:GLsizei, format:GLenum, type:GLenum, pixels:VoidPointer):Void;

	@:native('glTexSubImage2D')
	static function texSubImage2D(target:GLenum, level:GLint, xoffset:GLint, yoffset:GLint, width:GLsizei, height:GLsizei, format:GLenum, type:GLenum, pixels:VoidPointer):Void;
	...
	static function colorPointer(size:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;

	@:native('glDisableClientState')
	static function disableClientState(array:GLenum):Void;

	@:native('glEdgeFlagPointer')
	static function edgeFlagPointer(stride:GLsizei, pointer:VoidPointer):Void;

	@:native('glEnableClientState')
	static function enableClientState(array:GLenum):Void;

	@:native('glIndexPointer')
	static function indexPointer(type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;

	@:native('glInterleavedArrays')
	static function interleavedArrays(format:GLenum, stride:GLsizei, pointer:VoidPointer):Void;

	@:native('glNormalPointer')
	static function normalPointer(type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;

	@:native('glTexCoordPointer')
	static function texCoordPointer(size:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;

	@:native('glVertexPointer')
	static function vertexPointer(size:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function drawRangeElements(mode:GLenum, start:GLuint, end:GLuint, count:GLsizei, type:GLenum, indices:VoidPointer):Void;

	@:native('glTexImage3D')
	static function texImage3D(target:GLenum, level:GLint, internalformat:GLint, width:GLsizei, height:GLsizei, depth:GLsizei, border:GLint, format:GLenum, type:GLenum, pixels:VoidPointer):Void;

	@:native('glTexSubImage3D')
	static function texSubImage3D(target:GLenum, level:GLint, xoffset:GLint, yoffset:GLint, zoffset:GLint, width:GLsizei, height:GLsizei, depth:GLsizei, format:GLenum, type:GLenum, pixels:VoidPointer):Void;
	...
	static function compressedTexImage3D(target:GLenum, level:GLint, internalformat:GLenum, width:GLsizei, height:GLsizei, depth:GLsizei, border:GLint, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glCompressedTexImage2D')
	static function compressedTexImage2D(target:GLenum, level:GLint, internalformat:GLenum, width:GLsizei, height:GLsizei, border:GLint, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glCompressedTexImage1D')
	static function compressedTexImage1D(target:GLenum, level:GLint, internalformat:GLenum, width:GLsizei, border:GLint, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glCompressedTexSubImage3D')
	static function compressedTexSubImage3D(target:GLenum, level:GLint, xoffset:GLint, yoffset:GLint, zoffset:GLint, width:GLsizei, height:GLsizei, depth:GLsizei, format:GLenum, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glCompressedTexSubImage2D')
	static function compressedTexSubImage2D(target:GLenum, level:GLint, xoffset:GLint, yoffset:GLint, width:GLsizei, height:GLsizei, format:GLenum, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glCompressedTexSubImage1D')
	static function compressedTexSubImage1D(target:GLenum, level:GLint, xoffset:GLint, width:GLsizei, format:GLenum, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glGetCompressedTexImage')
	static function getCompressedTexImage(target:GLenum, level:GLint, img:VoidPointer):Void;
	...
	static function multiDrawElements(mode:GLenum, count:RawPointer<GLsizei>, type:GLenum, indices:RawPointer<VoidConstPointer>, drawcount:GLsizei):Void;
	...
	static function fogCoordPointer(type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function secondaryColorPointer(size:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	@:native('glBufferData')
	static function bufferData(target:GLenum, size:GLsizeiptr, data:VoidPointer, usage:GLenum):Void;

	@:native('glBufferSubData')
	static function bufferSubData(target:GLenum, offset:GLintptr, size:GLsizeiptr, data:VoidPointer):Void;

	@:native('glGetBufferSubData')
	static function getBufferSubData(target:GLenum, offset:GLintptr, size:GLsizeiptr, data:VoidPointer):Void;

	@:native('glMapBuffer')
	static function mapBuffer(target:GLenum, access:GLenum):VoidPointer;
	...
	static function getBufferPointerv(target:GLenum, pname:GLenum, params:RawPointer<VoidPointer>):Void;
	...
	static function getVertexAttribPointerv(index:GLuint, pname:GLenum, pointer:RawPointer<VoidPointer>):Void;
	...
	static function vertexAttribPointer(index:GLuint, size:GLint, type:GLenum, normalized:GLboolean, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function vertexAttribIPointer(index:GLuint, size:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function mapBufferRange(target:GLenum, offset:GLintptr, length:GLsizeiptr, access:GLbitfield):VoidPointer;
	...
	static function drawElementsInstanced(mode:GLenum, count:GLsizei, type:GLenum, indices:VoidPointer, instancecount:GLsizei):Void;
	...
	static function drawElementsBaseVertex(mode:GLenum, count:GLsizei, type:GLenum, indices:VoidPointer, basevertex:GLint):Void;

	@:native('glDrawRangeElementsBaseVertex')
	static function drawRangeElementsBaseVertex(mode:GLenum, start:GLuint, end:GLuint, count:GLsizei, type:GLenum, indices:VoidPointer, basevertex:GLint):Void;

	@:native('glDrawElementsInstancedBaseVertex')
	static function drawElementsInstancedBaseVertex(mode:GLenum, count:GLsizei, type:GLenum, indices:VoidPointer, instancecount:GLsizei, basevertex:GLint):Void;

	@:native('glMultiDrawElementsBaseVertex')
	static function multiDrawElementsBaseVertex(mode:GLenum, count:RawPointer<GLsizei>, type:GLenum, indices:RawPointer<VoidConstPointer>, drawcount:GLsizei, basevertex:RawPointer<GLint>):Void;
	...
	static function drawArraysIndirect(mode:GLenum, indirect:VoidPointer):Void;

	@:native('glDrawElementsIndirect')
	static function drawElementsIndirect(mode:GLenum, type:GLenum, indirect:VoidPointer):Void;
	...
	static function shaderBinary(count:GLsizei, shaders:RawPointer<GLuint>, binaryFormat:GLenum, binary:VoidPointer, length:GLsizei):Void;
	...
	static function getProgramBinary(program:GLuint, bufSize:GLsizei, length:RawPointer<GLsizei>, binaryFormat:RawPointer<GLenum>, binary:VoidPointer):Void;

	@:native('glProgramBinary')
	static function programBinary(program:GLuint, binaryFormat:GLenum, binary:VoidPointer, length:GLsizei):Void;
	...
	static function vertexAttribLPointer(index:GLuint, size:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function drawElementsInstancedBaseInstance(mode:GLenum, count:GLsizei, type:GLenum, indices:VoidPointer, instancecount:GLsizei, baseinstance:GLuint):Void;

	@:native('glDrawElementsInstancedBaseVertexBaseInstance')
	static function drawElementsInstancedBaseVertexBaseInstance(mode:GLenum, count:GLsizei, type:GLenum, indices:VoidPointer, instancecount:GLsizei, basevertex:GLint, baseinstance:GLuint):Void;
	...
	static function clearBufferData(target:GLenum, internalformat:GLenum, format:GLenum, type:GLenum, data:VoidPointer):Void;

	@:native('glClearBufferSubData')
	static function clearBufferSubData(target:GLenum, internalformat:GLenum, offset:GLintptr, size:GLsizeiptr, format:GLenum, type:GLenum, data:VoidPointer):Void;
	...
	static function multiDrawArraysIndirect(mode:GLenum, indirect:VoidPointer, drawcount:GLsizei, stride:GLsizei):Void;

	@:native('glMultiDrawElementsIndirect')
	static function multiDrawElementsIndirect(mode:GLenum, type:GLenum, indirect:VoidPointer, drawcount:GLsizei, stride:GLsizei):Void;
	...
	static function debugMessageCallback(callback:GLDEBUGPROC, userParam:VoidPointer):Void;
	...
	static function objectPtrLabel(ptr:VoidPointer, length:GLsizei, label:CastGLcharStar):Void;

	@:native('glGetObjectPtrLabel')
	static function getObjectPtrLabel(ptr:VoidPointer, bufSize:GLsizei, length:RawPointer<GLsizei>, label:CastGLcharStar):Void;

	@:native('glBufferStorage')
	static function bufferStorage(target:GLenum, size:GLsizeiptr, data:VoidPointer, flags:GLbitfield):Void;

	@:native('glClearTexImage')
	static function clearTexImage(texture:GLuint, level:GLint, format:GLenum, type:GLenum, data:VoidPointer):Void;

	@:native('glClearTexSubImage')
	static function clearTexSubImage(texture:GLuint, level:GLint, xoffset:GLint, yoffset:GLint, zoffset:GLint, width:GLsizei, height:GLsizei, depth:GLsizei, format:GLenum, type:GLenum, data:VoidPointer):Void;
	...
	static function namedBufferStorage(buffer:GLuint, size:GLsizeiptr, data:VoidPointer, flags:GLbitfield):Void;

	@:native('glNamedBufferData')
	static function namedBufferData(buffer:GLuint, size:GLsizeiptr, data:VoidPointer, usage:GLenum):Void;

	@:native('glNamedBufferSubData')
	static function namedBufferSubData(buffer:GLuint, offset:GLintptr, size:GLsizeiptr, data:VoidPointer):Void;
	...
	static function clearNamedBufferData(buffer:GLuint, internalformat:GLenum, format:GLenum, type:GLenum, data:VoidPointer):Void;

	@:native('glClearNamedBufferSubData')
	static function clearNamedBufferSubData(buffer:GLuint, internalformat:GLenum, offset:GLintptr, size:GLsizeiptr, format:GLenum, type:GLenum, data:VoidPointer):Void;

	@:native('glMapNamedBuffer')
	static function mapNamedBuffer(buffer:GLuint, access:GLenum):VoidPointer;

	@:native('glMapNamedBufferRange')
	static function mapNamedBufferRange(buffer:GLuint, offset:GLintptr, length:GLsizeiptr, access:GLbitfield):VoidPointer;
	...
	static function getNamedBufferPointerv(buffer:GLuint, pname:GLenum, params:RawPointer<VoidPointer>):Void;

	@:native('glGetNamedBufferSubData')
	static function getNamedBufferSubData(buffer:GLuint, offset:GLintptr, size:GLsizeiptr, data:VoidPointer):Void;
	...
	static function textureSubImage1D(texture:GLuint, level:GLint, xoffset:GLint, width:GLsizei, format:GLenum, type:GLenum, pixels:VoidPointer):Void;

	@:native('glTextureSubImage2D')
	static function textureSubImage2D(texture:GLuint, level:GLint, xoffset:GLint, yoffset:GLint, width:GLsizei, height:GLsizei, format:GLenum, type:GLenum, pixels:VoidPointer):Void;

	@:native('glTextureSubImage3D')
	static function textureSubImage3D(texture:GLuint, level:GLint, xoffset:GLint, yoffset:GLint, zoffset:GLint, width:GLsizei, height:GLsizei, depth:GLsizei, format:GLenum, type:GLenum, pixels:VoidPointer):Void;

	@:native('glCompressedTextureSubImage1D')
	static function compressedTextureSubImage1D(texture:GLuint, level:GLint, xoffset:GLint, width:GLsizei, format:GLenum, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glCompressedTextureSubImage2D')
	static function compressedTextureSubImage2D(texture:GLuint, level:GLint, xoffset:GLint, yoffset:GLint, width:GLsizei, height:GLsizei, format:GLenum, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glCompressedTextureSubImage3D')
	static function compressedTextureSubImage3D(texture:GLuint, level:GLint, xoffset:GLint, yoffset:GLint, zoffset:GLint, width:GLsizei, height:GLsizei, depth:GLsizei, format:GLenum, imageSize:GLsizei, data:VoidPointer):Void;
	...
	static function getTextureImage(texture:GLuint, level:GLint, format:GLenum, type:GLenum, bufSize:GLsizei, pixels:VoidPointer):Void;

	@:native('glGetCompressedTextureImage')
	static function getCompressedTextureImage(texture:GLuint, level:GLint, bufSize:GLsizei, pixels:VoidPointer):Void;
	...
	static function getTextureSubImage(texture:GLuint, level:GLint, xoffset:GLint, yoffset:GLint, zoffset:GLint, width:GLsizei, height:GLsizei, depth:GLsizei, format:GLenum, type:GLenum, bufSize:GLsizei, pixels:VoidPointer):Void;

	@:native('glGetCompressedTextureSubImage')
	static function getCompressedTextureSubImage(texture:GLuint, level:GLint, xoffset:GLint, yoffset:GLint, zoffset:GLint, width:GLsizei, height:GLsizei, depth:GLsizei, bufSize:GLsizei, pixels:VoidPointer):Void;

	@:native('glGetGraphicsResetStatus')
	static function getGraphicsResetStatus():GLenum;

	@:native('glGetnCompressedTexImage')
	static function getnCompressedTexImage(target:GLenum, lod:GLint, bufSize:GLsizei, pixels:VoidPointer):Void;

	@:native('glGetnTexImage')
	static function getnTexImage(target:GLenum, level:GLint, format:GLenum, type:GLenum, bufSize:GLsizei, pixels:VoidPointer):Void;
	...
	static function readnPixels(x:GLint, y:GLint, width:GLsizei, height:GLsizei, format:GLenum, type:GLenum, bufSize:GLsizei, data:VoidPointer):Void;
	...
	static function getnColorTable(target:GLenum, format:GLenum, type:GLenum, bufSize:GLsizei, table:VoidPointer):Void;

	@:native('glGetnConvolutionFilter')
	static function getnConvolutionFilter(target:GLenum, format:GLenum, type:GLenum, bufSize:GLsizei, image:VoidPointer):Void;

	@:native('glGetnSeparableFilter')
	static function getnSeparableFilter(target:GLenum, format:GLenum, type:GLenum, rowBufSize:GLsizei, row:VoidPointer, columnBufSize:GLsizei, column:VoidPointer, span:VoidPointer):Void;

	@:native('glGetnHistogram')
	static function getnHistogram(target:GLenum, reset:GLboolean, format:GLenum, type:GLenum, bufSize:GLsizei, values:VoidPointer):Void;

	@:native('glGetnMinmax')
	static function getnMinmax(target:GLenum, reset:GLboolean, format:GLenum, type:GLenum, bufSize:GLsizei, values:VoidPointer):Void;
	...
	static function multiDrawArraysIndirectCount(mode:GLenum, indirect:VoidPointer, drawcount:GLintptr, maxdrawcount:GLsizei, stride:GLsizei):Void;

	@:native('glMultiDrawElementsIndirectCount')
	static function multiDrawElementsIndirectCount(mode:GLenum, type:GLenum, indirect:VoidPointer, drawcount:GLintptr, maxdrawcount:GLsizei, stride:GLsizei):Void;
	...
	static function debugMessageCallbackAMD(callback:GLDEBUGPROCAMD, userParam:VoidPointer):Void;
	...
	static function multiDrawArraysIndirectAMD(mode:GLenum, indirect:VoidPointer, primcount:GLsizei, stride:GLsizei):Void;

	@:native('glMultiDrawElementsIndirectAMD')
	static function multiDrawElementsIndirectAMD(mode:GLenum, type:GLenum, indirect:VoidPointer, primcount:GLsizei, stride:GLsizei):Void;
	...
	static function getPerfMonitorCounterInfoAMD(group:GLuint, counter:GLuint, pname:GLenum, data:VoidPointer):Void;
	...
	static function elementPointerAPPLE(type:GLenum, pointer:VoidPointer):Void;
	...
	static function textureRangeAPPLE(target:GLenum, length:GLsizei, pointer:VoidPointer):Void;

	@:native('glGetTexParameterPointervAPPLE')
	static function getTexParameterPointervAPPLE(target:GLenum, pname:GLenum, params:RawPointer<VoidPointer>):Void;
	...
	static function vertexArrayRangeAPPLE(length:GLsizei, pointer:VoidPointer):Void;

	@:native('glFlushVertexArrayRangeAPPLE')
	static function flushVertexArrayRangeAPPLE(length:GLsizei, pointer:VoidPointer):Void;
	...
	static function debugMessageCallbackARB(callback:GLDEBUGPROCARB, userParam:VoidPointer):Void;
	...
	static function drawElementsInstancedARB(mode:GLenum, count:GLsizei, type:GLenum, indices:VoidPointer, primcount:GLsizei):Void;
	...
	static function multiDrawArraysIndirectCountARB(mode:GLenum, indirect:VoidPointer, drawcount:GLintptr, maxdrawcount:GLsizei, stride:GLsizei):Void;

	@:native('glMultiDrawElementsIndirectCountARB')
	static function multiDrawElementsIndirectCountARB(mode:GLenum, type:GLenum, indirect:VoidPointer, drawcount:GLintptr, maxdrawcount:GLsizei, stride:GLsizei):Void;
	...
	static function matrixIndexPointerARB(size:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function getnTexImageARB(target:GLenum, level:GLint, format:GLenum, type:GLenum, bufSize:GLsizei, img:VoidPointer):Void;

	@:native('glReadnPixelsARB')
	static function readnPixelsARB(x:GLint, y:GLint, width:GLsizei, height:GLsizei, format:GLenum, type:GLenum, bufSize:GLsizei, data:VoidPointer):Void;

	@:native('glGetnCompressedTexImageARB')
	static function getnCompressedTexImageARB(target:GLenum, lod:GLint, bufSize:GLsizei, img:VoidPointer):Void;
	...
	static function compressedTexImage3DARB(target:GLenum, level:GLint, internalformat:GLenum, width:GLsizei, height:GLsizei, depth:GLsizei, border:GLint, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glCompressedTexImage2DARB')
	static function compressedTexImage2DARB(target:GLenum, level:GLint, internalformat:GLenum, width:GLsizei, height:GLsizei, border:GLint, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glCompressedTexImage1DARB')
	static function compressedTexImage1DARB(target:GLenum, level:GLint, internalformat:GLenum, width:GLsizei, border:GLint, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glCompressedTexSubImage3DARB')
	static function compressedTexSubImage3DARB(target:GLenum, level:GLint, xoffset:GLint, yoffset:GLint, zoffset:GLint, width:GLsizei, height:GLsizei, depth:GLsizei, format:GLenum, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glCompressedTexSubImage2DARB')
	static function compressedTexSubImage2DARB(target:GLenum, level:GLint, xoffset:GLint, yoffset:GLint, width:GLsizei, height:GLsizei, format:GLenum, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glCompressedTexSubImage1DARB')
	static function compressedTexSubImage1DARB(target:GLenum, level:GLint, xoffset:GLint, width:GLsizei, format:GLenum, imageSize:GLsizei, data:VoidPointer):Void;

	@:native('glGetCompressedTexImageARB')
	static function getCompressedTexImageARB(target:GLenum, level:GLint, img:VoidPointer):Void;
	...
	static function weightPointerARB(size:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function bufferDataARB(target:GLenum, size:GLsizeiptrARB, data:VoidPointer, usage:GLenum):Void;

	@:native('glBufferSubDataARB')
	static function bufferSubDataARB(target:GLenum, offset:GLintptrARB, size:GLsizeiptrARB, data:VoidPointer):Void;

	@:native('glGetBufferSubDataARB')
	static function getBufferSubDataARB(target:GLenum, offset:GLintptrARB, size:GLsizeiptrARB, data:VoidPointer):Void;

	@:native('glMapBufferARB')
	static function mapBufferARB(target:GLenum, access:GLenum):VoidPointer;
	...
	static function getBufferPointervARB(target:GLenum, pname:GLenum, params:RawPointer<VoidPointer>):Void;
	...
	static function vertexAttribPointerARB(index:GLuint, size:GLint, type:GLenum, normalized:GLboolean, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function programStringARB(target:GLenum, format:GLenum, len:GLsizei, string:VoidPointer):Void;
	...
	static function getProgramStringARB(target:GLenum, pname:GLenum, string:VoidPointer):Void;
	...
	static function getVertexAttribPointervARB(index:GLuint, pname:GLenum, pointer:RawPointer<VoidPointer>):Void;
	...
	static function elementPointerATI(type:GLenum, pointer:VoidPointer):Void;
	...
	static function mapObjectBufferATI(buffer:GLuint):VoidPointer;
	...
	static function newObjectBufferATI(size:GLsizei, pointer:VoidPointer, usage:GLenum):GLuint;

	@:native('glIsObjectBufferATI')
	static function isObjectBufferATI(buffer:GLuint):GLboolean;

	@:native('glUpdateObjectBufferATI')
	static function updateObjectBufferATI(buffer:GLuint, offset:GLuint, size:GLsizei, pointer:VoidPointer, preserve:GLenum):Void;
	...
	static function colorSubTableEXT(target:GLenum, start:GLsizei, count:GLsizei, format:GLenum, type:GLenum, data:VoidPointer):Void;
	...
	static function convolutionFilter1DEXT(target:GLenum, internalformat:GLenum, width:GLsizei, format:GLenum, type:GLenum, image:VoidPointer):Void;

	@:native('glConvolutionFilter2DEXT')
	static function convolutionFilter2DEXT(target:GLenum, internalformat:GLenum, width:GLsizei, height:GLsizei, format:GLenum, type:GLenum, image:VoidPointer):Void;
	...
	static function getConvolutionFilterEXT(target:GLenum, format:GLenum, type:GLenum, image:VoidPointer):Void;
	...
	static function getSeparableFilterEXT(target:GLenum, format:GLenum, type:GLenum, row:VoidPointer, column:VoidPointer, span:VoidPointer):Void;

	@:native('glSeparableFilter2DEXT')
	static function separableFilter2DEXT(target:GLenum, internalformat:GLenum, width:GLsizei, height:GLsizei, format:GLenum, type:GLenum, row:VoidPointer, column:VoidPointer):Void;
	...
	static function tangentPointerEXT(type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;

	@:native('glBinormalPointerEXT')
	static function binormalPointerEXT(type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function drawElementsInstancedEXT(mode:GLenum, count:GLsizei, type:GLenum, indices:VoidPointer, primcount:GLsizei):Void;

	@:native('glDrawRangeElementsEXT')
	static function drawRangeElementsEXT(mode:GLenum, start:GLuint, end:GLuint, count:GLsizei, type:GLenum, indices:VoidPointer):Void;
	...
	static function fogCoordPointerEXT(type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function getHistogramEXT(target:GLenum, reset:GLboolean, format:GLenum, type:GLenum, values:VoidPointer):Void;
	...
	static function getMinmaxEXT(target:GLenum, reset:GLboolean, format:GLenum, type:GLenum, values:VoidPointer):Void;
	...
	static function importMemoryWin32HandleEXT(memory:GLuint, size:GLuint64, handleType:GLenum, handle:VoidPointer):Void;

	@:native('glImportMemoryWin32NameEXT')
	static function importMemoryWin32NameEXT(memory:GLuint, size:GLuint64, handleType:GLenum, name:VoidPointer):Void;
	...
	static function multiDrawElementsEXT(mode:GLenum, count:RawPointer<GLsizei>, type:GLenum, indices:RawPointer<VoidConstPointer>, primcount:GLsizei):Void;
	...
	static function colorTableEXT(target:GLenum, internalFormat:GLenum, width:GLsizei, format:GLenum, type:GLenum, table:VoidPointer):Void;

	@:native('glGetColorTableEXT')
	static function getColorTableEXT(target:GLenum, format:GLenum, type:GLenum, data:VoidPointer):Void;
	...
	static function importSemaphoreWin32HandleEXT(semaphore:GLuint, handleType:GLenum, handle:VoidPointer):Void;

	@:native('glImportSemaphoreWin32NameEXT')
	static function importSemaphoreWin32NameEXT(semaphore:GLuint, handleType:GLenum, name:VoidPointer):Void;
	...
	static function secondaryColorPointerEXT(size:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function texSubImage1DEXT(target:GLenum, level:GLint, xoffset:GLint, width:GLsizei, format:GLenum, type:GLenum, pixels:VoidPointer):Void;

	@:native('glTexSubImage2DEXT')
	static function texSubImage2DEXT(target:GLenum, level:GLint, xoffset:GLint, yoffset:GLint, width:GLsizei, height:GLsizei, format:GLenum, type:GLenum, pixels:VoidPointer):Void;

	@:native('glTexImage3DEXT')
	static function texImage3DEXT(target:GLenum, level:GLint, internalformat:GLenum, width:GLsizei, height:GLsizei, depth:GLsizei, border:GLint, format:GLenum, type:GLenum, pixels:VoidPointer):Void;

	@:native('glTexSubImage3DEXT')
	static function texSubImage3DEXT(target:GLenum, level:GLint, xoffset:GLint, yoffset:GLint, zoffset:GLint, width:GLsizei, height:GLsizei, depth:GLsizei, format:GLenum, type:GLenum, pixels:VoidPointer):Void;
	...
	static function colorPointerEXT(size:GLint, type:GLenum, stride:GLsizei, count:GLsizei, pointer:VoidPointer):Void;
	...
	static function getPointervEXT(pname:GLenum, params:RawPointer<VoidPointer>):Void;

	@:native('glIndexPointerEXT')
	static function indexPointerEXT(type:GLenum, stride:GLsizei, count:GLsizei, pointer:VoidPointer):Void;

	@:native('glNormalPointerEXT')
	static function normalPointerEXT(type:GLenum, stride:GLsizei, count:GLsizei, pointer:VoidPointer):Void;

	@:native('glTexCoordPointerEXT')
	static function texCoordPointerEXT(size:GLint, type:GLenum, stride:GLsizei, count:GLsizei, pointer:VoidPointer):Void;

	@:native('glVertexPointerEXT')
	static function vertexPointerEXT(size:GLint, type:GLenum, stride:GLsizei, count:GLsizei, pointer:VoidPointer):Void;
	...
	static function vertexAttribLPointerEXT(index:GLuint, size:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function setInvariantEXT(id:GLuint, type:GLenum, addr:VoidPointer):Void;

	@:native('glSetLocalConstantEXT')
	static function setLocalConstantEXT(id:GLuint, type:GLenum, addr:VoidPointer):Void;
	...
	static function variantPointerEXT(id:GLuint, type:GLenum, stride:GLuint, addr:VoidPointer):Void;
	...
	static function getVariantPointervEXT(id:GLuint, value:GLenum, data:RawPointer<VoidPointer>):Void;
	...
	static function vertexWeightPointerEXT(size:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function stringMarkerGREMEDY(len:GLsizei, string:VoidPointer):Void;
	...
	static function multiModeDrawElementsIBM(mode:RawPointer<GLenum>, count:RawPointer<GLsizei>, type:GLenum, indices:RawPointer<VoidConstPointer>, primcount:GLsizei, modestride:GLint):Void;

	@:native('glFlushStaticDataIBM')
	static function flushStaticDataIBM(target:GLenum):Void;

	@:native('glColorPointerListIBM')
	static function colorPointerListIBM(size:GLint, type:GLenum, stride:GLint, pointer:RawPointer<VoidPointer>, ptrstride:GLint):Void;

	@:native('glSecondaryColorPointerListIBM')
	static function secondaryColorPointerListIBM(size:GLint, type:GLenum, stride:GLint, pointer:RawPointer<VoidPointer>, ptrstride:GLint):Void;
	...
	static function fogCoordPointerListIBM(type:GLenum, stride:GLint, pointer:RawPointer<VoidPointer>, ptrstride:GLint):Void;

	@:native('glIndexPointerListIBM')
	static function indexPointerListIBM(type:GLenum, stride:GLint, pointer:RawPointer<VoidPointer>, ptrstride:GLint):Void;

	@:native('glNormalPointerListIBM')
	static function normalPointerListIBM(type:GLenum, stride:GLint, pointer:RawPointer<VoidPointer>, ptrstride:GLint):Void;

	@:native('glTexCoordPointerListIBM')
	static function texCoordPointerListIBM(size:GLint, type:GLenum, stride:GLint, pointer:RawPointer<VoidPointer>, ptrstride:GLint):Void;

	@:native('glVertexPointerListIBM')
	static function vertexPointerListIBM(size:GLint, type:GLenum, stride:GLint, pointer:RawPointer<VoidPointer>, ptrstride:GLint):Void;
	...
	static function mapTexture2DINTEL(texture:GLuint, level:GLint, access:GLbitfield, stride:RawPointer<GLint>, layout:RawPointer<GLenum>):VoidPointer;

	@:native('glVertexPointervINTEL')
	static function vertexPointervINTEL(size:GLint, type:GLenum, pointer:RawPointer<VoidPointer>):Void;

	@:native('glNormalPointervINTEL')
	static function normalPointervINTEL(type:GLenum, pointer:RawPointer<VoidPointer>):Void;

	@:native('glColorPointervINTEL')
	static function colorPointervINTEL(size:GLint, type:GLenum, pointer:RawPointer<VoidPointer>):Void;

	@:native('glTexCoordPointervINTEL')
	static function texCoordPointervINTEL(size:GLint, type:GLenum, pointer:RawPointer<VoidPointer>):Void;
	...
	static function getPerfQueryDataINTEL(queryHandle:GLuint, flags:GLuint, dataSize:GLsizei, data:VoidPointer, bytesWritten:RawPointer<GLuint>):Void;
	...
	static function lGPUNamedBufferSubDataNVX(gpuMask:GLbitfield, buffer:GLuint, offset:GLintptr, size:GLsizeiptr, data:VoidPointer):Void;
	...
	static function multiDrawArraysIndirectBindlessNV(mode:GLenum, indirect:VoidPointer, drawCount:GLsizei, stride:GLsizei, vertexBufferCount:GLint):Void;

	@:native('glMultiDrawElementsIndirectBindlessNV')
	static function multiDrawElementsIndirectBindlessNV(mode:GLenum, type:GLenum, indirect:VoidPointer, drawCount:GLsizei, stride:GLsizei, vertexBufferCount:GLint):Void;

	@:native('glMultiDrawArraysIndirectBindlessCountNV')
	static function multiDrawArraysIndirectBindlessCountNV(mode:GLenum, indirect:VoidPointer, drawCount:GLsizei, maxDrawCount:GLsizei, stride:GLsizei, vertexBufferCount:GLint):Void;

	@:native('glMultiDrawElementsIndirectBindlessCountNV')
	static function multiDrawElementsIndirectBindlessCountNV(mode:GLenum, type:GLenum, indirect:VoidPointer, drawCount:GLsizei, maxDrawCount:GLsizei, stride:GLsizei, vertexBufferCount:GLint):Void;
	...
	static function listDrawCommandsStatesClientNV(list:GLuint, segment:GLuint, indirects:RawPointer<VoidPointer>, sizes:RawPointer<GLsizei>, states:RawPointer<GLuint>, fbos:RawPointer<GLuint>, count:GLuint):Void;
	...
	static function mapControlPointsNV(target:GLenum, index:GLuint, type:GLenum, ustride:GLsizei, vstride:GLsizei, uorder:GLint, vorder:GLint, packed:GLboolean, points:VoidPointer):Void;
	...
	static function getMapControlPointsNV(target:GLenum, index:GLuint, type:GLenum, ustride:GLsizei, vstride:GLsizei, packed:GLboolean, points:VoidPointer):Void;
	...
	static function multicastBufferSubDataNV(gpuMask:GLbitfield, buffer:GLuint, offset:GLintptr, size:GLsizeiptr, data:VoidPointer):Void;
	...
	static function pathCommandsNV(path:GLuint, numCommands:GLsizei, commands:RawPointer<GLubyte>, numCoords:GLsizei, coordType:GLenum, coords:VoidPointer):Void;

	@:native('glPathCoordsNV')
	static function pathCoordsNV(path:GLuint, numCoords:GLsizei, coordType:GLenum, coords:VoidPointer):Void;

	@:native('glPathSubCommandsNV')
	static function pathSubCommandsNV(path:GLuint, commandStart:GLsizei, commandsToDelete:GLsizei, numCommands:GLsizei, commands:RawPointer<GLubyte>, numCoords:GLsizei, coordType:GLenum, coords:VoidPointer):Void;

	@:native('glPathSubCoordsNV')
	static function pathSubCoordsNV(path:GLuint, coordStart:GLsizei, numCoords:GLsizei, coordType:GLenum, coords:VoidPointer):Void;

	@:native('glPathStringNV')
	static function pathStringNV(path:GLuint, format:GLenum, length:GLsizei, pathString:VoidPointer):Void;

	@:native('glPathGlyphsNV')
	static function pathGlyphsNV(firstPathName:GLuint, fontTarget:GLenum, fontName:VoidPointer, fontStyle:GLbitfield, numGlyphs:GLsizei, type:GLenum, charcodes:VoidPointer, handleMissingGlyphs:GLenum, pathParameterTemplate:GLuint, emScale:GLfloat):Void;

	@:native('glPathGlyphRangeNV')
	static function pathGlyphRangeNV(firstPathName:GLuint, fontTarget:GLenum, fontName:VoidPointer, fontStyle:GLbitfield, firstGlyph:GLuint, numGlyphs:GLsizei, handleMissingGlyphs:GLenum, pathParameterTemplate:GLuint, emScale:GLfloat):Void;
	...
	static function stencilFillPathInstancedNV(numPaths:GLsizei, pathNameType:GLenum, paths:VoidPointer, pathBase:GLuint, fillMode:GLenum, mask:GLuint, transformType:GLenum, transformValues:RawPointer<GLfloat>):Void;

	@:native('glStencilStrokePathInstancedNV')
	static function stencilStrokePathInstancedNV(numPaths:GLsizei, pathNameType:GLenum, paths:VoidPointer, pathBase:GLuint, reference:GLint, mask:GLuint, transformType:GLenum, transformValues:RawPointer<GLfloat>):Void;
	...
	static function coverFillPathInstancedNV(numPaths:GLsizei, pathNameType:GLenum, paths:VoidPointer, pathBase:GLuint, coverMode:GLenum, transformType:GLenum, transformValues:RawPointer<GLfloat>):Void;

	@:native('glCoverStrokePathInstancedNV')
	static function coverStrokePathInstancedNV(numPaths:GLsizei, pathNameType:GLenum, paths:VoidPointer, pathBase:GLuint, coverMode:GLenum, transformType:GLenum, transformValues:RawPointer<GLfloat>):Void;
	...
	static function getPathMetricsNV(metricQueryMask:GLbitfield, numPaths:GLsizei, pathNameType:GLenum, paths:VoidPointer, pathBase:GLuint, stride:GLsizei, metrics:RawPointer<GLfloat>):Void;
	...
	static function getPathSpacingNV(pathListMode:GLenum, numPaths:GLsizei, pathNameType:GLenum, paths:VoidPointer, pathBase:GLuint, advanceScale:GLfloat, kerningScale:GLfloat, transformType:GLenum, returnedSpacing:RawPointer<GLfloat>):Void;
	...
	static function pixelDataRangeNV(target:GLenum, length:GLsizei, pointer:VoidPointer):Void;
	...
	static function vDPAUInitNV(vdpDevice:VoidPointer, getProcAddress:VoidPointer):Void;

	@:native('glVDPAUFiniNV')
	static function vDPAUFiniNV():Void;

	@:native('glVDPAURegisterVideoSurfaceNV')
	static function vDPAURegisterVideoSurfaceNV(vdpSurface:VoidPointer, target:GLenum, numTextureNames:GLsizei, textureNames:RawPointer<GLuint>):GLvdpauSurfaceNV;

	@:native('glVDPAURegisterOutputSurfaceNV')
	static function vDPAURegisterOutputSurfaceNV(vdpSurface:VoidPointer, target:GLenum, numTextureNames:GLsizei, textureNames:RawPointer<GLuint>):GLvdpauSurfaceNV;
	...
	static function vDPAURegisterVideoSurfaceWithPictureStructureNV(vdpSurface:VoidPointer, target:GLenum, numTextureNames:GLsizei, textureNames:RawPointer<GLuint>, isFrameStructure:GLboolean):GLvdpauSurfaceNV;

	@:native('glFlushVertexArrayRangeNV')
	static function flushVertexArrayRangeNV():Void;

	@:native('glVertexArrayRangeNV')
	static function vertexArrayRangeNV(length:GLsizei, pointer:VoidPointer):Void;
	...
	static function getVertexAttribPointervNV(index:GLuint, pname:GLenum, pointer:RawPointer<VoidPointer>):Void;
	...
	static function vertexAttribPointerNV(index:GLuint, fsize:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function vertexAttribIPointerEXT(index:GLuint, size:GLint, type:GLenum, stride:GLsizei, pointer:VoidPointer):Void;
	...
	static function texImage4DSGIS(target:GLenum, level:GLint, internalformat:GLenum, width:GLsizei, height:GLsizei, depth:GLsizei, size4d:GLsizei, border:GLint, format:GLenum, type:GLenum, pixels:VoidPointer):Void;

	@:native('glTexSubImage4DSGIS')
	static function texSubImage4DSGIS(target:GLenum, level:GLint, xoffset:GLint, yoffset:GLint, zoffset:GLint, woffset:GLint, width:GLsizei, height:GLsizei, depth:GLsizei, size4d:GLsizei, format:GLenum, type:GLenum, pixels:VoidPointer):Void;
	...
	static function iglooInterfaceSGIX(pname:GLenum, params:VoidPointer):Void;
	...
	static function colorTableSGI(target:GLenum, internalformat:GLenum, width:GLsizei, format:GLenum, type:GLenum, table:VoidPointer):Void;
	...
	static function getColorTableSGI(target:GLenum, format:GLenum, type:GLenum, table:VoidPointer):Void;
	...
	static function replacementCodePointerSUN(type:GLenum, stride:GLsizei, pointer:RawPointer<VoidPointer>):Void;
