...
extern class DrMP3
{
	...
	static function open_memory_and_read_pcm_frames_f32(data:RawConstPointer<cpp.Void>, dataSize:SizeT, pConfig:RawPointer<DrMP3_Config>,
		totalPCMFrameCount:RawPointer<DrMP3_UInt64>, pAllocationCallbacks:RawConstPointer<DrMP3_Allocation_Callbacks>):RawPointer<Float32>;
